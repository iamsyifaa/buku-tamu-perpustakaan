...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700&family=Fraunces:ital,opsz,wght@0,9..144,500;0,9..144,600;1,9..144,500&display=swap"
        rel="stylesheet">
    <style>
        :root {
            --navy: #13273F;
        ...
        <aside class="brand-panel">
            ...
            <div class="brand-top">
                <div class="brand-crest">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#E9D4C3" stroke-width="1.6" stroke-linecap="round"
                ...
                <p class="brand-desc">Kelola koleksi buku, data anggota, dan peminjaman perpustakaan desa dengan satu
                    pintu akses yang aman dan terpercaya.</p>
            </div>
        ...
        <main class="form-panel">
            <div class="form-wrap">
                ...
                <form method="POST" action="{{ route('admin.login.post') }}" id="admin-login-form">
                    ...
                    <button class="btn" type="submit" id="btn-admin-login">Masuk ke Panel</button>
                </form>
