    ...
    <div class="split-shell">
        ...
        <div class="split-form-wrap">
            <div class="split-form">
                ...
                <button class="btn" id="btn-login" type="button" onclick="doLogin()">Masuk Sekarang</button>
    ...
    @push('modals')
        <div class="modal-overlay" id="modal-login">
            <div class="modal-box">
                ...
                <button class="btn" id="btn-go-aktivitas" type="button" onclick="goToAktivitas()">Lanjut ke
                    Aktivitas</button>
            </div>
        </div>
    @endpush
    ...
    @push('scripts')
        <script>
            ...
            function goToAktivitas() {
                const btn = document.getElementById('btn-go-aktivitas');
                if (btn.disabled) return;
                btn.disabled = true;
